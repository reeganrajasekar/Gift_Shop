...
<body style="height:700px">
 ...
 <!-- Mini Cart -->
        ...
        <?php 
            $id=$_GET['id'];
            $sql = "SELECT * from gift where id='$id' order by id DESC";
            $result = $conn->query($sql);
    ...
    <div class="product-section section pt-30 pb-30">
        <div class="container">
            ...
            <!-- Section Title Start-->
            <div class="row">
                <div class="section-title text-center col mb-10">
            ...
            <div class="row">
                ...
                <div class="col-6 ">
                    ...
                    <div class="product">
                        ...
                        <div class="image">
                            <!-- Image -->
                            <a href="/user/view.php?id=<?php echo$row['id']?>" class="img"><img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['img']); ?>" alt="Product"></a>
                            <!-- Wishlist -->
                            <!-- Label -->
