      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card border-1 shadow rounded-1 my-2" >
          <div class="card-body p-4 p-sm-5">
            <h5 class="card-title text-center mb-5 fw-light "><b>Signup</b></h5>
            ...
            <div class="form-floating mb-3">
              ...
              <div class="form-floating mb-3">
                <input type="text" required class="form-control" name="mob" id="floatingInput" placeholder="name@example.com">
              ...
              <div class="form-floating mb-3">
              <input type="text" required name="addr" class="form-control" id="floatingInput" placeholder="name@example.com">
              ...
              <hr class="my-3">
                <h5 class="card-title text-center">Do You have an account? <a href="./Login.php" style="color:red">SignIn!</a></h5>  
